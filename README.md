...
Atualmente se encontra na versão 4.0, compatível com o IPED a partir das versões do 4.0.0. **No final desta página 👇 está disponivel o arquivo IPEDIAR4.zip para download**.
