...
Em razão de fatores críticos de segurança, e ainda atendendo recomendações da empresa desenvolvedora do Windows (Microsoft), este aplicativo foi desenvolvido de forma que **não é executável no Windows 7**, haja vista que o próprio fabricante não presta mais suporte a referida versão. 
...
Após isso, o caminho da pasta ORIGEM será exibido ao lado do botão ORIGEM para fins de visualização e conferência.
...
Com os dados das pastas de ORIGEM e DESTINO preenchidos resta agora clicar no botão INDEXAR e aguardar o processamento e a indexação pelo IPED. Ao final desse passo, o resultado poderá ser visualizado de imediato ou posteriormente acessando a pasta de DESTINO e clincando no arquivo IPED-SearchApp.exe. 
![image](https://user-images.githubusercontent.com/5096974/182137311-753e040f-4ae8-4b63-acb2-8aeb8a37353e.png)👈
